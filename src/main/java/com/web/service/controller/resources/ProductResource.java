...
import com.web.service.model.services.ProductService;

/**
 * 
 * Classe responsável por disponibilizar o recurso web referente a entidade Product
 * 
 * @author fsouviei
 *
 */
...
public class ProductResource {
	...
	public ResponseEntity<List<Product>> findAll(){
		...
		return ResponseEntity.ok().body(list);// retorna 'ok', resposta com sucesso, e body corpo da respota vai receber o Product
	}
